...
# Discord参数
discord_webhook_url = "https://discord.com/api/webhooks/"  # 填入你的Discord Webhook URL
discord_message = "kuzco运行异常，正在重启程序..."  # 填入需要发送的消息内容
...
def start_kuzco(workers):
    print("启动1号kuzco中")
    os.system("kuzco worker start > /root/log.txt 2>&1 &")
    time.sleep(6)
